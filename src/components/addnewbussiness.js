    ...
    <div>
      ...
      <div className="AddBussinessContainer">
        <div className="AddBussinessInputs">
          ...
          {profileImageUpload && <div style={{ display: 'flex', backgroundColor: 'whitesmoke', padding: '10px', borderRadius: '10px', margin: '20px', flexWrap: 'wrap', justifyContent: 'center' }}>


            <div className="image">
              <img style={{ borderRadius: '100%' }} src={URL.createObjectURL(profileImageUpload)} height="120" width='120' alt="upload" />
